...
import { Constants, FieldType, FileType, 
// utility functions
exportWithFormatterWhenDefined, getColumnFieldType, getTranslationPrefix, isColumnDateType, sanitizeHtmlToText, } from '@slickgrid-universal/common';
...
export class ExcelExportService {
    ...
    init(grid, containerService) {
        ...
        this._locales = (_b = (_a = this._gridOptions) === null || _a === void 0 ? void 0 : _a.locales) !== null && _b !== void 0 ? _b : Constants.locales;
    ...
    readGroupedTotalRows(columns, itemObj) {
        ...
        columns.forEach((columnDef) => {
            ...
            if (fieldType === FieldType.number && autoDetectCellFormat !== false) {
                ...
                const groupTotalParser = (_f = (_e = columnDef.groupTotalsExcelExportOptions) === null || _e === void 0 ? void 0 : _e.valueParserCallback) !== null && _f !== void 0 ? _f : getGroupTotalValue;
