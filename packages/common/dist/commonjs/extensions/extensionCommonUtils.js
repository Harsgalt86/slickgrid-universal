...
function addColumnTitleElementWhenDefined(menuElm) {
    ...
    if ((_a = context.addonOptions) === null || _a === void 0 ? void 0 : _a.columnTitle) {
        context._columnTitleElm = (0, domUtilities_1.createDomElement)('div', { className: 'slick-menu-title', textContent: (_c = (_b = context.addonOptions) === null || _b === void 0 ? void 0 : _b.columnTitle) !== null && _c !== void 0 ? _c : context._defaults.columnTitle }, menuElm);
    }
}
...
function populateColumnPicker(addonOptions) {
    ...
    for (const column of context.columns) {
        ...
        labelElm.innerHTML = (0, domUtilities_1.sanitizeTextByAvailableSanitizer)(context.gridOptions, columnLabel);
