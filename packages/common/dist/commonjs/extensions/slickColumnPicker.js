...
class SlickColumnPicker {
    ...
    createPickerMenu() {
        const menuElm = (0, domUtilities_1.createDomElement)('div', {
            ariaExpanded: 'true',
        ...
        extensionCommonUtils_1.addColumnTitleElementWhenDefined.call(this, menuElm);
        extensionCommonUtils_1.addCloseButtomElement.call(this, menuElm);
        this._listElm = (0, domUtilities_1.createDomElement)('div', { className: 'slick-column-picker-list', role: 'menu' });
        this._bindEventService.bind(menuElm, 'click', extensionCommonUtils_1.handleColumnPickerItemClick.bind(this), undefined, 'parent-menu');
