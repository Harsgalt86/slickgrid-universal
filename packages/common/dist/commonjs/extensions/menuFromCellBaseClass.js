...
class MenuFromCellBaseClass extends menuBaseClass_1.MenuBaseClass {
    ...
    createMenu(commandItems, optionItems, level = 0, item) {
        ...
        if ((_g = this.addonOptions) === null || _g === void 0 ? void 0 : _g.width) {
            menuElm.style.width = (0, domUtilities_1.findWidthOrDefault)((_h = this.addonOptions) === null || _h === void 0 ? void 0 : _h.width);
        }
        const closeButtonElm = (0, domUtilities_1.createDomElement)('button', { ariaLabel: 'Close', className: 'close', type: 'button', textContent: '×', dataset: { dismiss: this._menuCssPrefix } });
        // -- Option List section
        if (!this.addonOptions.hideOptionSection && isColumnOptionAllowed && optionItems.length > 0) {
            const optionMenuElm = (0, domUtilities_1.createDomElement)('div', { className: `${this._menuCssPrefix}-option-list`, role: 'menu' }, menuElm);
        ...
        if (!this.addonOptions.hideCommandSection && isColumnCommandAllowed && commandItems.length > 0) {
            const commandMenuElm = (0, domUtilities_1.createDomElement)('div', { className: `${this._menuCssPrefix}-command-list`, role: 'menu' }, menuElm);
    ...
    repositionMenu(event, menuElm) {
        ...
        if (menuElm && parentElm) {
            ...
            const parentOffset = (0, domUtilities_1.getHtmlElementOffset)(parentElm);
            ...
            if (this._addonOptions.autoAdjustDrop || this._addonOptions.dropDirection) {
                ...
                const { bottom: spaceBottom, top: spaceTop } = (0, domUtilities_1.calculateAvailableSpace)(parentElm);
