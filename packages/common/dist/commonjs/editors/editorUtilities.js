...
exports.getEditorOptionByName = void 0;
/**
 ...
 */
function getEditorOptionByName(columnEditor, optionName, defaultValue, editorName = 'Slider') {
    var _a, _b, _c;
    let outValue;
...
exports.getEditorOptionByName = getEditorOptionByName;
