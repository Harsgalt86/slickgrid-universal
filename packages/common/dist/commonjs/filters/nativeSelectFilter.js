...
class NativeSelectFilter {
    ...
    buildFilterSelectFromCollection(collection) {
        ...
        const selectElm = (0, domUtilities_1.createDomElement)('select', {
            className: `form-control search-filter filter-${columnId}`,
            ariaLabel: (_d = (_c = this.columnFilter) === null || _c === void 0 ? void 0 : _c.ariaLabel) !== null && _d !== void 0 ? _d : `${(0, utils_1.toSentenceCase)(columnId + '')} Search Filter`
        });
