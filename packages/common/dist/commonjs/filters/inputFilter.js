...
class InputFilter {
    ...
    createDomFilterElement(searchTerm) {
        ...
        if (this.inputFilterType === 'single') {
            ...
            const containerInputGroupElm = (0, services_1.createDomElement)('div', { className: 'input-group' }, this._filterContainerElm);
            const operatorInputGroupAddonElm = (0, services_1.createDomElement)('div', { className: 'input-group-addon input-group-prepend operator' }, containerInputGroupElm);
