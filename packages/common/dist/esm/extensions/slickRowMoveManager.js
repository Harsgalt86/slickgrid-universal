    ...
    handleDrag(e, dd) {
        ...
        if (this._dragging) {
            ...
            if (insertBefore !== dd.insertBefore) {
                ...
                if (((_f = (_e = this._addonOptions) === null || _e === void 0 ? void 0 : _e.onBeforeMoveRows) === null || _f === void 0 ? void 0 : _f.call(_e, e, eventData)) === false || this.onBeforeMoveRows.notify(eventData).getReturnValue() === false) {
                    dd.canMove = false;
                }
                else {
                    dd.canMove = true;
