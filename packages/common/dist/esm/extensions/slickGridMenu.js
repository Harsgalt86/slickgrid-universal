...
export class SlickGridMenu extends MenuBaseClass {
    ...
    showGridMenu(e, options) {
        ...
        if (this._addonOptions) {
            ...
            this._menuElm = this.createCommandMenu((_d = (_c = this._addonOptions) === null || _c === void 0 ? void 0 : _c.commandItems) !== null && _d !== void 0 ? _d : []);
            ...
            this._menuElm.style.minHeight = findWidthOrDefault(addonOptions === null || addonOptions === void 0 ? void 0 : addonOptions.minHeight, '');
            if ((addonOptions === null || addonOptions === void 0 ? void 0 : addonOptions.height) !== undefined) {
                ...
                this._menuElm.style.maxHeight = findWidthOrDefault(addonOptions === null || addonOptions === void 0 ? void 0 : addonOptions.maxHeight, `${window.innerHeight - targetEvent.clientY - menuMarginBottom}px`);
            }
    ...
    recreateCommandList(commandItems, menuElm, callbackArgs, item) {
        ...
        if (commandItems.length > 0) {
            ...
            if (level === 0) {
                ...
                const commandMenuHeaderElm = (_a = menuElm.querySelector(`.slick-command-header`)) !== null && _a !== void 0 ? _a : createDomElement('div', { className: 'slick-command-header' });
