...
import { buildMultipleSelectDataCollection, emptyElement, sanitizeTextByAvailableSanitizer } from '../services/index';
...
export class SelectFilter {
    ...
    init(args) {
        ...
        this._locales = (_p = (_o = this.gridOptions) === null || _o === void 0 ? void 0 : _o.locales) !== null && _p !== void 0 ? _p : Constants.locales;
    ...
    renderDomElement(inputCollection) {
        ...
        const selectBuildResult = buildMultipleSelectDataCollection('filter', newCollection, this.columnDef, this.grid, this.isMultipleSelect, this.translaterService, this.searchTerms || []);
    ...
    createFilterElement(selectElement, dataCollection) {
        ...
        this._msInstance = multipleSelect(selectElement, this.filterElmOptions);
    }
