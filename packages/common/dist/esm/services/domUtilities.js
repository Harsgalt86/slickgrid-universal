 ...
 */
export function buildMultipleSelectDataCollection(type, collection, columnDef, grid, isMultiSelect = false, translaterService, searchTerms) {
 ...
 */
export function createDomElement(tagName, elementOptions, appendToParent) {
...
export function getElementProp(elm, property) {
