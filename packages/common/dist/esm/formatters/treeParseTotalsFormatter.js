...
export const treeParseTotalsFormatter = (row, cell, value, columnDef, dataContext, grid) => {
    var _a, _b;
    const gridOptions = grid.getOptions();
    const hasChildrenPropName = (_b = (_a = gridOptions === null || gridOptions === void 0 ? void 0 : gridOptions.treeDataOptions) === null || _a === void 0 ? void 0 : _a.hasChildrenPropName) !== null && _b !== void 0 ? _b : Constants.treeDataProperties.HAS_CHILDREN_PROP;
