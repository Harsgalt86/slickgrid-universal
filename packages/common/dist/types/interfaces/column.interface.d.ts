import type { CellMenu, ColumnEditor, ColumnExcelExportOption, ColumnFilter, CustomTooltipOption, EditorValidator, Formatter, Grouping, GroupTotalExportOption, GroupTotalsFormatter, HeaderButtonsOrMenu, OnEventArgs, SlickEventData, SlickGrid, SortComparer } from './index';
...
export interface Column<T = any> {
    ...
    } | ((row: number, cell: number, val: any, columnDef: Column, item: any, grid: SlickGrid) => Formatter<T>);
